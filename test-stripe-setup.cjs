...
// Convert publishable key to secret key format for testing (this won't work for actual API calls)
const TEST_SECRET_KEY = STRIPE_PUBLISHABLE_KEY.replace('pk_live_', 'sk_live_');
