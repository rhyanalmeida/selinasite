...
const SignupPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      // Check if user intended to subscribe to a product
      ...
      if (intendedProduct) {
        try {
          ...
          const product = getProductByPriceId(intendedProduct);
          if (product) {
            await createCheckoutSession(intendedProduct);
          }
        } catch (checkoutError) {
          console.error('Checkout error after signup:', checkoutError);
          // If checkout fails, just navigate to programs
          navigate('/programs');
        }
  ...
  return (
    <>
      <Helmet>
        <title>Create Account - Mountain Meditation & Yoga | Join Our Community</title>
        <meta name="description" content="Create your Mountain Meditation & Yoga account to access meditation programs, track progress, and start your spiritual journey." />
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-green-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
            ...
            <p className="text-gray-600">Create your account to start your meditation journey</p>
          </div>
